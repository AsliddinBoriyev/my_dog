...
import 'package:my_dog/pages/mobile/home_screen.dart';
import 'package:my_dog/pages/profile_page.dart';
...
class HomePage extends StatefulWidget {
  ...
  const HomePage({Key? key, this.crossAxisCount = 2, this.subPage = 0})
      : super(key: key);
...
class _HomePageState extends State<HomePage> {
  ...
  Color _iconColor(int page) =>
      _initialPage == page ? Colors.black : Colors.grey;
        ...
        ? Scaffold(
            ...
            body: Row(
              children: [
                        ...
                        children: [
                          ...
                          ListTile(
                            ...
                            leading: Icon(Icons.home_filled,
                                size: _iconSize(0), color: _iconColor(0)),
                          ...
                          ListTile(
                            ...
                            leading: Icon(Icons.search,
                                size: _iconSize(1), color: _iconColor(1)),
                          ...
                          ListTile(
                            ...
                            leading: Icon(Icons.chat_bubble_outlined,
                                size: _iconSize(2), color: _iconColor(2)),
                          ...
                          ListTile(
                            ...
                            leading: Icon(CupertinoIcons.profile_circled,
                                size: _iconSize(3), color: _iconColor(3)),
                ...
                Visibility(
                  visible:
                      widget.crossAxisCount > 3 && widget.crossAxisCount < 6,
            ...
            floatingActionButton: widget.crossAxisCount <= 3
                ? Container(
                    height: 70,
